...
*/
    ...
    private void registerUser(){
        ...
        final String reg_1 = regno.getText().toString().trim();
...
*/
        ...
        if(reg_1.length()!=12){
            Toast.makeText(this,"Enter valid 12 digit AU registraion number",Toast.LENGTH_SHORT).show();
        }
...
//                            );
                            ...
                            FirebaseDatabase.getInstance().getReference("Students").child(reg_1)
    ...
    public void onClick(View v) {
        ...
        if(v==mentor){
            startActivity(new Intent(Main2Activity.this,Mentor.class));
        }
    }
