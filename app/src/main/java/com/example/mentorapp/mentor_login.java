...
public class mentor_login extends AppCompatActivity implements View.OnClickListener{
        ...
        firebaseAuth.signInWithEmailAndPassword(email_id10, pass_id1)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Toast.makeText(mentor_login.this, "Registration Error", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
