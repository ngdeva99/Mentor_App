                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            startActivity(new Intent(getApplicationContext(),mentor_main.class));
                            //success registration
                            Toast.makeText(Mentor.this,"Registered Successfuly",Toast.LENGTH_SHORT).show();
...
//                            );
                            ...
                            FirebaseDatabase.getInstance().getReference("Mentor").child(FirebaseAuth.getInstance().getCurrentUser().getEmail().replace(".", "").substring(0, FirebaseAuth.getInstance().getCurrentUser().getEmail().indexOf('@')))
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful())
                                    {
                                        Toast.makeText(Mentor.this, "success", Toast.LENGTH_SHORT).show();
                                    }
                                    else
                                    {
                                        Toast.makeText(Mentor.this, "failed", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            ...
                            Toast.makeText(Mentor.this,"Registered Unsuccessful",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void onClick(View v) {
        ...
        if(v==signuplogin){
            startActivity(new Intent(Mentor.this,mentor_login.class));
        }
